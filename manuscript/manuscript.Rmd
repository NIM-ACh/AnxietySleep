...
# beck_global
lm(sqrt(beck_global) ~ sex * zone, data) |> anova() |> report::report_statistics()

# pits_global
lm(sqrt(pits_global) ~ sex * zone, data) |> anova() |> report::report_statistics()
...
model <- copy(data)[, `:=`(
  ...
  BAI = beck_global,
  PSQI = pits_global
)] |> lm(formula = sqrt(PSQI) ~ Sex + sqrt(BAI))
